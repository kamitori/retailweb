...
<body>
<img src="{{baseURL}}/themes/banhmisub/images/big-logo.png" alt="" id="logo">
<div class="address">
...
<!-- <div class="paid">Paid by: {{payment_method}}</div> -->
<div class="paid-detail">
	<span class="left">Total Payment:</span>
	<span class="right"><?php echo number_format((double)$main_total,2) ?></span>
	{% if cart['payment_method'] is defined %}
		{% for kp,payment in cart['payment_method'] %}
			<span class="left" style="font-weight:300;">{{kp}}:</span>
			<span class="right" style="font-weight:300;"><?php echo number_format((double)$payment,2) ?></span>
		{% endfor %}
	{% endif %}
	<span class="left">Amount Tendered:</span>
	<span class="right"><?php echo number_format((double)$amount_tendered,2) ?></span>
	<span class="left">Change Due:</span>
	<span class="right"><?php echo number_format((double)$change_due,2) ?></span>
