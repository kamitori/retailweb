<form>
 <div class="product_left shadow">
        <div class="box-table">
            <table cellpadding="0" cellspacing="0" id="retrieve_order_list">
               <thead>
                  <tr>
                    ...
                    {% if(_list_orders) %}
                        {% for item in _list_orders %}
                            <tr>             
                                ...
                                <td>
                                    <input type="button" class="form-control btn-small btn-primary" value="Retrieve" onclick="_retrieveSO('{{item['_id']}}');" />
                                </td>
                          </tr>          
                        {% endfor %}
                    {% else %}
