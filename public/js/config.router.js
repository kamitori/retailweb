...
angular.module('app')
    ...
    .config(function($authProvider) {
        $authProvider.configure({
            apiUrl: appHelper.adminURL(),
            signOutUrl: '/auth/logout',
            emailSignInPath: '/auth/login',
            tokenValidationPath: '/auth/token-validate'
        });
    })
    .config(
            ...
            function($stateProvider, $urlRouterProvider, JQ_CONFIG) {
                ...
                $stateProvider
                    ...
                    .state('app.menu', {
                        ...
                        templateUrl: 'tpl/menus/index.html',
                    })
                    .state('app.product', {
                        ...
                        reloadOnSearch: false,
                        templateUrl: 'tpl/products/index.html',
                    })
                    .state('app.product-category', {
                        url: '/product-categories/:action/:id',
                        params: {
                            action: {
                                value: 'list'
                            },
                        ...
                        reloadOnSearch: false,
                        templateUrl: 'tpl/product-categories/index.html',
                    })
                    .state('app.option', {
                        url: '/options/:action/:id',
                        params: {
                            action: {
                                value: 'list'
                            },
                        ...
                        reloadOnSearch: false,
                        templateUrl: 'tpl/options/index.html',
                    })					
                    .state('app.banner', {
                        url: '/banners/:action/:id',
                        params: {
                            action: {
                                value: 'list'
                            },
                        ...
                        reloadOnSearch: false,
                        templateUrl: 'tpl/banners/index.html',
                    })
                    .state('app.admin', {
                        ...
                        reloadOnSearch: false,
                        templateUrl: 'tpl/admins/index.html',
                    })
                    .state('app.configure', {
                        url: '/configures/:action/:id',
                        params: {
                            action: {
                                value: 'list'
                            },
                        ...
                        reloadOnSearch: false,
                        templateUrl: 'tpl/configures/index.html',
                    })
                    .state('app.vouchers', {
                        ...
                        reloadOnSearch: false,
                        templateUrl: 'tpl/vouchers/index.html',
                    })
                    .state('app.static-page', {
                        ...
                        reloadOnSearch: false,
                        templateUrl: 'tpl/pages/index.html',
                    })
                    .state('app.ui', {
                        url: '/ui',
